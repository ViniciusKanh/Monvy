...
export default async function handler(req, res) {
  ...
  try {
    ...
    sendMail({ to: u.email, subject: 'Monvy — Senha redefinida', html: tpl('Senha redefinida com sucesso', `Sua senha foi alterada em ${new Date().toLocaleString('pt-BR')}. Se nao foi voce, entre em contato imediatamente.`) }).catch(() => {});
