...
import parseInforme from '../_handlers/ai_parse_informe.js';
import parseDanfe from '../_handlers/ai_parse_danfe.js';
import assistant from '../_handlers/ai_assistant.js';
import { sendJson } from '../_lib/auth.js';

const map = { 'parse-invoice': parseInvoice, 'parse-informe': parseInforme, 'parse-danfe': parseDanfe, assistant };
